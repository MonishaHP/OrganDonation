...
public class registerReader {
	...
	public void setup() throws InterruptedException {
		...
		this.driver.get("D:/Web/register1.html");
//Thread.sleep(2000);

	}

	@Test(dataProvider = "getData")
	public void test(String fullname, String username, String email, String phoneno, String pwd, String cpwd,
			String gender) throws Exception {

		this.driver.findElement(By.id("text")).sendKeys(fullname);
		this.driver.findElement(By.id("username")).sendKeys(username);
		
		this.driver.findElement(By.id("number")).sendKeys(phoneno);
		this.driver.findElement(By.id("Email_Id")).sendKeys(email);
		this.driver.findElement(By.id("Password")).sendKeys(pwd);
		this.driver.findElement(By.id("ConfirmPassword")).sendKeys(cpwd);
